...
public class DeleteEmployee {
    ...
    sel.selectByVisibleText(selectspecificelement);
	
    
    //enter empid in search for
    
    driver.findElement(By.id("loc_name")).sendKeys(empid);
    
    driver.findElement(By.xpath("//*[@id='standardView']/div[2]/input[2]")).click();
    
    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='standardView']/table/tbody/tr/td[1]/input"))).click();
    ...
    if(msgText.equals("Successfully Deleted")){
	  System.out.println(empid +" Employee deleted succesfully");
     }
	  else
